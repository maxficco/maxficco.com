...
class chain{
    ...
    draw_outline() {
        ...
        if (theme === "light") {
            ctx.fillStyle = "rgba(100, 100, 200, 0.3)"; // Semi-transparent blue
        } else {
            ctx.fillStyle = "rgba(200, 100, 100, 0.3)"; // Semi-transparent red
        }
        ctx.fill();
        if (theme === "light") {
            ctx.strokeStyle = "rgba(0, 0, 200, 0.8)"; // More solid blue outline
        } else {
        ...
        ctx.closePath();
        if (theme === "light") {
            ctx.fillStyle = "rgba(100, 100, 200, 0.9)"; // Semi-transparent blue
        } else {
...
document.addEventListener('keydown', function(event) {
    ...
    if (key === 'a') {
        if (outline) body = 1 - body;
        outline = 1 - outline;
        console.log(body, outline)
    }
});
